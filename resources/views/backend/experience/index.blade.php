        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex flex-wrap justify-content-between">
                            <h3 class="card-title line-height-36">{{ __('experience_list') }}
                                ({{ count($experiences) }})</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (userCan('professions.update'))
                                                <a href="{{ route('experience.edit', $exp->id) }}" class="btn bg-info"><i
            ...
            <div class="col-md-4">
                @if (!empty($experience) && userCan('professions.update'))
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36">{{ __('edit') }} {{ __('experience') }}</h3>
                        ...
                        <div class="card-body">
                            <div class="pt-3 pb-4">
                                <form class="form-horizontal" action="{{ route('experience.update', $experience->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                ...
                @else
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36">{{ __('create') }} {{ __('experience') }}</h3>
                        </div>
                        <div class="card-body">
                            @if (userCan('job_role.create'))
                                <form class="form-horizontal" action="{{ route('experience.store') }}" method="POST">
                                    @csrf
                                    @foreach ($app_language as $key => $language)
                                        @php
                                            $label = __('name') . ' ' . getLanguageByCodeInLookUp($language->code, $app_language);
