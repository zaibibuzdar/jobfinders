        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex flex-wrap justify-content-between">
                            <h3 class="card-title line-height-36">{{ __('education_list') }}
                                ({{ count($educations) }})</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (userCan('professions.update'))
                                                <a href="{{ route('education.edit', $edu->id) }}" class="btn bg-info"><i
            ...
            <div class="col-md-4">
                @if (!empty($education) && userCan('professions.update'))
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36">{{ __('edit') }} {{ __('education') }}</h3>
                        ...
                        <div class="card-body">
                            <div class="pt-3 pb-4">
                                <form class="form-horizontal" action="{{ route('education.update', $education->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                ...
                @else
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36">{{ __('create') }} {{ __('education') }}</h3>
                        </div>
                        <div class="card-body">
