        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex flex-wrap justify-content-between">
                            <h3 class="card-title line-height-36">{{ __('salary_types_list') }}
                                ({{ $salaryTypes ? count($salaryTypes) : '0' }})</h3>
            ...
            <div class="col-md-4">
                @if (!empty($salaryType_id))
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36">{{ __('edit') }} {{ __('salary_type') }}</h3>
                        ...
                        <div class="card-body">
                            <form class="form-horizontal"
                                action="{{ route('salaryType.update', $salaryType_id->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                ...
                @if (empty($salaryType_id))
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title line-height-36">{{ __('create') }} {{ __('salary_type') }}</h3>
                        </div>
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('salaryType.store') }}" method="POST">
                                @csrf
                                @foreach ($app_language as $key => $language)
                                    @php
                                        $label = __('name') . ' ' . getLanguageByCodeInLookUp($language->code,$app_language);
